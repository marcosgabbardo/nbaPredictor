...
CREATE TABLE `nba_game` (
  ...
  `fg_home_p1` decimal(10,3) DEFAULT NULL,
  `fg_home_p2` decimal(10,3) DEFAULT NULL,
  `fg_home_p3` decimal(10,3) DEFAULT NULL,
  `fg_home_p4` decimal(10,3) DEFAULT NULL,
  `fg_away_p1` decimal(10,3) DEFAULT NULL,
  `fg_away_p2` decimal(10,3) DEFAULT NULL,
  `fg_away_p3` decimal(10,3) DEFAULT NULL,
  `fg_away_p4` decimal(10,3) DEFAULT NULL,
  `to_home_p1` decimal(10,3) DEFAULT NULL,
  `to_home_p2` decimal(10,3) DEFAULT NULL,
  `to_home_p3` decimal(10,3) DEFAULT NULL,
  `to_home_p4` decimal(10,3) DEFAULT NULL,
  `to_away_p1` decimal(10,3) DEFAULT NULL,
  `to_away_p2` decimal(10,3) DEFAULT NULL,
  `to_away_p3` decimal(10,3) DEFAULT NULL,
  `to_away_p4` decimal(10,3) DEFAULT NULL,
  `rb_home_p1` decimal(10,3) DEFAULT NULL,
  `rb_home_p2` decimal(10,3) DEFAULT NULL,
  `rb_home_p3` decimal(10,3) DEFAULT NULL,
  `rb_home_p4` decimal(10,3) DEFAULT NULL,
  `rb_away_p1` decimal(10,3) DEFAULT NULL,
  `rb_away_p2` decimal(10,3) DEFAULT NULL,
  `rb_away_p3` decimal(10,3) DEFAULT NULL,
  `rb_away_p4` decimal(10,3) DEFAULT NULL,
  KEY `idx_date` (`date`),
  KEY `idx_id2` (`id2`),
  KEY `idx_season_nbagame` (`season`),
  KEY `idx_fghomep1` (`fg_home_p1`),
...
CREATE TABLE `nba_playbyplay` (
  ...
  `home_cumulative_score` int(3) DEFAULT NULL,
  `away_cumulative_score` int(3) DEFAULT NULL,
  KEY `edx_id` (`id`),
...
CREATE TABLE `nba_team_history` (
  ...
  `pointavg3a` decimal(10,2) DEFAULT NULL,
  `pointavg5a` decimal(10,2) DEFAULT NULL,
  `pointavg10a` decimal(10,2) DEFAULT NULL,
  ...
  `pace_avg1` decimal(10,2) DEFAULT NULL,
  `efg_avg1` decimal(10,2) DEFAULT NULL,
  `tov_avg1` decimal(10,2) DEFAULT NULL,
  `orb_avg1` decimal(10,2) DEFAULT NULL,
  `ftfga_avg1` decimal(10,2) DEFAULT NULL,
  `ortg_avg1` decimal(10,2) DEFAULT NULL,
  `pace_avg3` decimal(10,2) DEFAULT NULL,
  `efg_avg3` decimal(10,2) DEFAULT NULL,
  `tov_avg3` decimal(10,2) DEFAULT NULL,
  `orb_avg3` decimal(10,2) DEFAULT NULL,
  `ftfga_avg3` decimal(10,2) DEFAULT NULL,
  `ortg_avg3` decimal(10,2) DEFAULT NULL,
  `pace_avg5` decimal(10,2) DEFAULT NULL,
  `efg_avg5` decimal(10,2) DEFAULT NULL,
  `tov_avg5` decimal(10,2) DEFAULT NULL,
  `orb_avg5` decimal(10,2) DEFAULT NULL,
  `ftfga_avg5` decimal(10,2) DEFAULT NULL,
  `ortg_avg5` decimal(10,2) DEFAULT NULL,
  `pace_avg10` decimal(10,2) DEFAULT NULL,
  `efg_avg10` decimal(10,2) DEFAULT NULL,
  `tov_avg10` decimal(10,2) DEFAULT NULL,
  `orb_avg10` decimal(10,2) DEFAULT NULL,
  `ftfga_avg10` decimal(10,2) DEFAULT NULL,
  `ortg_avg10` decimal(10,2) DEFAULT NULL,
  ...
  `p1_avg5` decimal(10,3) DEFAULT NULL,
  `p2_avg5` decimal(10,3) DEFAULT NULL,
  `p3_avg5` decimal(10,3) DEFAULT NULL,
  `p4_avg5` decimal(10,3) DEFAULT NULL,
  `p1_avg10` decimal(10,3) DEFAULT NULL,
  `p2_avg10` decimal(10,3) DEFAULT NULL,
  `p3_avg10` decimal(10,3) DEFAULT NULL,
  `p4_avg10` decimal(10,3) DEFAULT NULL,
